 ...
 * zudem wird das Interface MainPanelInterface implementiert
 * @author bettray
 *
 */
public class MainPanel extends JPanel implements ActionListener, MainPanelInterface
{
	...
	/**
	 * Sichtbarkeit der Eingabe-Komponenten setzen. Methode ueber Interface MainPanelInterface implementiert
	 */
	@Override
	public void setInputComponentsVisible(boolean b)
	{
		inputPanel.setVisible(b);	// inputPanel sichtbar/unsichtbar machen
		send.setVisible(b);			// send-Button sichtbar/unsichtbar machen
	}
